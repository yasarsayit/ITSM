<%@ Page Title="Device-Software Assignments Report" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DeviceSoftwareReport.aspx.cs" Inherits="ITSM.DeviceSoftwareReport" %>
    ...
    <div class="container-fluid" style="padding: 20px;">
        <div class="card shadow mb-4">
            <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #0F406B; color: white;">
                <h3 class="card-title mb-0" style="font-size: 16px;"><i class="fal fa-laptop-code me-2"></i>Active Device-Software List</h3>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <asp:Repeater ID="rptAssignedSoftware" runat="server">
                        <HeaderTemplate>
                            <table class="table table-sm table-bordered table-hover align-middle">
                                <thead class="table-light text-nowrap">
                                    ...
                                    <tr class="arama">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtFSoftware" runat="server" CssClass="form-control form-control-sm frmara" placeholder="Search Software..."></asp:TextBox>
                                        </td>
                                        <td>
                                        ...
                                        <td style="text-align: center;">
                                            <div class="btn-group btn-group-sm gridsearchgrp">
                                                <asp:LinkButton ID="lbClearFilters" runat="server" CssClass="btn btn-warning btn-sm gridsearchbtn" OnClick="lbAraTemizle_Click" title="Clear Filters"><i class="fas fa-broom"></i></asp:LinkButton>
                                                <asp:LinkButton ID="lbSearch" runat="server" CssClass="btn btn-primary btn-sm gridsearchbtn" OnClick="lbAra_Click" title="Search"><i class="fas fa-search"></i></asp:LinkButton>
                                            </div>
                                        </td>
                                    </tr>
                                </thead>
                        ...
                        <ItemTemplate>
                            <tr>
                                <td><%# Eval("Model") %> (<%# Eval("SerialNumber") %>)</td>
                                <td><%# Eval("SoftwareDesc") %></td>
